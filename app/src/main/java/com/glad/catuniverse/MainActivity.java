package com.glad.catuniverse;//package com.example.gravity;
...
public class MainActivity extends MainRunActivity {
    ...
    protected void onResume() {
        ...
        strategyDB.execSQL("CREATE TABLE IF NOT EXISTS strategy (_id INTEGER, stars INTEGER, ach INTEGER)");
        strategyDB.execSQL("INSERT into strategy (_id, stars, ach) VALUES (1,0,-1)");
        strategyDB.execSQL("INSERT into strategy (_id, stars, ach) VALUES (2,0,-1)");
        strategyDB.execSQL("INSERT into strategy (_id, stars, ach) VALUES (3,0,-1)");
        strategyDB.execSQL("INSERT into strategy (_id, stars, ach) VALUES (4,0,-1)");
        strategyDB.execSQL("INSERT into strategy (_id, stars, ach) VALUES (5,0,-1)");
        strategyDB.execSQL("INSERT into strategy (_id, stars, ach) VALUES (6,0,-1)");
        ...
        mathsDB.execSQL("CREATE TABLE IF NOT EXISTS maths (_id INTEGER, stars INTEGER, ach INTEGER)");
        mathsDB.execSQL("INSERT into maths (_id, stars, ach) VALUES (1,0,-1)");
        mathsDB.execSQL("INSERT into maths (_id, stars, ach) VALUES (2,0,-1)");
        mathsDB.execSQL("INSERT into maths (_id, stars, ach) VALUES (3,0,-1)");
        mathsDB.execSQL("INSERT into maths (_id, stars, ach) VALUES (4,0,-1)");
        mathsDB.execSQL("INSERT into maths (_id, stars, ach) VALUES (5,0,-1)");
        mathsDB.execSQL("INSERT into maths (_id, stars, ach) VALUES (6,0,-1)");
        mathsDB.execSQL("INSERT into maths (_id, stars, ach) VALUES (7,0,-1)");
        mathsDB.execSQL("INSERT into maths (_id, stars, ach) VALUES (8,0,-1)");
        mathsDB.execSQL("INSERT into maths (_id, stars, ach) VALUES (9,0,-1)");
        for (int i = 0; i < BasicGameSupport.levelsCount; i++) {
